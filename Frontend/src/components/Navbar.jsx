...
function Navbar({ onHelpClick }) {
  ...
  return (
    <nav className="flex items-center justify-between px-6 py-4 backdrop-blur border-b border-white/10 bg-black/20 text-white">
      ...
      <div className="space-x-6 hidden md:flex items-center">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {dropdownOpen && (
            <div className="absolute bg-black border border-white/10 rounded-md shadow-lg mt-2 min-w-[160px] z-50">
              <Link
                to="/fusion/maker"
